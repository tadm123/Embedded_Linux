/* This program prints the raw and G values of the MPU-6050 (accelerometer/gyroscope) */
 ...
 * 2. MPU-6000 and MPU-6050 Register Map and Description Revision 4.2
 */
...
/* These are the addresses of MPU-6050 from which you will fetch accelerometer x,y,z high and low values */
...
/* These are the addresses of MPU-6050 from which you will fetch gyroscope x,y,z high and low values */
...
/*
 * Different full scale range for acc and gyro
...
/* This is the linux OS device file for the I2C3 controller of the SoC */
#define I2C_DEVICE_FILE                 "/dev/i2c-2"

int fd;

/* Write an 8-bit "data" to the sensor at the address indicated by "addr" */
